...
if (chmod("../tmp", 0777)) {
    print '<span style="color: green;">Права на временный каталог tmp заданы успешно</span><br>';
} else {
    print '<span style="color: red;">Права на каталог tmp задать не удалось</span><br>';
}
